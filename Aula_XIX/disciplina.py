...
class CtrlDisciplina(): 
    def __init__(self):
        if not os.path.isfile("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/disciplina.pickle"):
            ...
            with open("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/disciplina.pickle", "rb") as f:
                self.listaDisciplinas = pickle.load(f)

    def salvaDisciplinas(self):
        if len(self.listaDisciplinas) != 0:
            with open("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/disciplina.pickle","wb") as f:
