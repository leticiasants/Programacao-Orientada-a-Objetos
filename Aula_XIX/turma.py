...
class CtrlTurma():  
    def __init__(self, controlePrincipal):
        ...
        if not os.path.isfile("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/turma.pickle"):
            self.listaTurmas =  []
        else:
            with open("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/turma.pickle", "rb") as f:
    ...
    def salvaTurmas(self):
        if len(self.listaTurmas) != 0:
            with open("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/turma.pickle","wb") as f:
