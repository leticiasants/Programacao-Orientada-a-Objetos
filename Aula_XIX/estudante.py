...
class CtrlEstudante():       
    def __init__(self):
        if not os.path.isfile("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/estudante.pickle"):
            self.listaEstudantes =  []
        else:
            with open("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/estudante.pickle", "rb") as f:
                self.listaEstudantes = pickle.load(f)

    def salvaEstudantes(self):
        if len(self.listaEstudantes) != 0:
            with open("/Users/Letícia/Documents/Development/Orientada_a_Objetos/Aula_XIX/estudante.pickle","wb") as f:
