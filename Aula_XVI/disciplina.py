...
class LimiteInsereDisciplinas(tk.Toplevel):
    def __init__(self, controle):
        ...
        self.inuputCodigo = tk.Entry(self.frameCodigo, width=20)
        self.inuputCodigo.pack(side="left")
...
class CtrlDisciplina():       
    ...
    def mostraDisciplinas(self):
        ...
        for dis in self.listaDisciplinas:
            str += dis.codigo + ' -- ' + dis.nome + '\n'
        self.limiteLista = LimiteMostraDisciplinas(str)

    def enterHandler(self, event):
        codigo = self.limiteIns.inuputCodigo.get()
    ...
    def clearHandler(self, event):
        self.limiteIns.inuputCodigo.delete(0, len(self.limiteIns.inuputCodigo.get()))
